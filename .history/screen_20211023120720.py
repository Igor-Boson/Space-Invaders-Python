...
class Screen:
    def __init__(self, handler, width=1000, height=700, background_color=Color.BLACK, font_type="monospace", font_size=35, clock_tick=60):
        self.handler = handler
        self.width = width
        self.height = height
        self.background_color = background_color
        self.screen = pygame.display.set_mode((width, height))
        self.screen = pygame.display.set_caption('joguinho')
